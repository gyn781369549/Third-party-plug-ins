...
<body>
        ...
        <div class="tabCont label_infor" id="tags" >
	                	...
	                	<c:forEach var="tip" items="${tips}">
	                		<li p_id="${tip}">
	                    		<input type="hidden" name="tips" value="${tip}">
	                     		<a href="javascript:;" onclick="deleteTips(this)" d_id="${tip.id }">${tip.type }</a>
	                     	</li>
	                	</c:forEach>
                	</c:if>
            ...
            <form action="${ctx }/mall/mallCommodityAction/typeAdd" method="post">
            <div class="addTips">
            	<span>添加类别:</span>
            	<input type="text" width="160px;" height="40px;" name="type"  />
