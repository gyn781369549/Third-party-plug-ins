<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <header class="enroll_header">
 	...
 	<!-- <a href="http://meididi.com.cn/admin" style="color: #000;" target="_blank">漾世代后台管理</a>
	<a href="http://meididi.com.cn/consult/login" style="color: #000;" target="_blank">咨询师咨询入口</a> -->
