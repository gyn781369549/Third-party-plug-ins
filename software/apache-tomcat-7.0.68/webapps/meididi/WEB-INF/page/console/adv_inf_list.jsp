...
<!--
 ...
 <input
				...
				onclick="window.location.href = '${ctx}/manage/upload/kindeditor/jsp/adv/save_Adv.jsp'">
		</div>
				...
				<tbody>
					...
					<c:forEach var="account" items="${ladv}"
						...
						<tr>
							...
							<td class="account_name">${account.content }</td>
							<td class="account_name">${account.typeValue }</td>
							<td class="account_name">${account.level }</td>
							<td>
							<div class="operation_box">
									<p class="operation_link">
										<a
											href="${ctx }/web/adv/ht_List?id=${account.id}">
