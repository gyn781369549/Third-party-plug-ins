		...
		<form action="${contextPath}/mall/mallCommodityAction/add" method="post" name="picForm"
			...
			<table  cellpadding="0" cellspacing="0" >
				...
				<tr>
				 ...
				 <IFRAME height=100 src="${contextPath}/manage/upload/kindeditor/jsp/text/text.jsp" width=300 ></IFRAME>  
				<tr>
					<td>安全性</td>
					<td> 
				...
				<tr>
					<td>原价</td>
					<td> <input type="text" style="width: 45px;" id="cost" name="cost" /></td>
				</tr>
				<tr>
					<td>售价</td>
					<td> <input type="text"  style="width: 45px;" id="price" name="price" /></td>
				</tr>
					<tr>
					<td>商品是否上线</td>
