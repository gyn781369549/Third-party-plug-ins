...
<body style="background-image:url(${contextPath}/manage/upload/img/bs.jpg);"  topmargin=0 leftmargin=0 onload="init()">
		...
		<h1><center>广告发布</center></h1>
		<form action="${contextPath}/web/adv/add" method="post" name="picForm"
			...
			<table  cellpadding="0" cellspacing="0" >
				...
				<tr>
					...
					<tr>
					<td>URL</td>
					<td> <input type="text" style="width: 645px;" id="url" name="url" /></td>
				</tr>
				<tr>
					<td>排序</td>
					<td> <input type="text"  style="width: 645px;" id="url" name="level" /></td>
				</tr>
				<tr>
					<td>广告类别</td>
					<td> <select name=type >
