...
SWFUpload.prototype.initSWFUpload = function(b) {
	try {
		...
		//重名随机创建
		var mydate = new Date();
	    this.movieName = "SWFUpload_" + mydate.getTime().toString()+Math.random().toString();
	...
	var handlers = {
		...
		onUploadError : function(file, errorCode, errorMsg) {
			...
			case SWFUpload.UPLOAD_ERROR.UPLOAD_LIMIT_EXCEEDED:
				//alert('每次最多上传(' + errorMsg + ')个');
				errorString = '每次最多上传(' + errorMsg + ')个';
				break;
